...
import Announcement from '@/views/admin/annoucement/announcementPage.vue'
import Announcements from '@/views/admin/annoucement/announcementsPage.vue'
import EditAnnouncment from '@/views/admin/annoucement/edit.vue'
import EmployeeSuggestions from '@/views/employee/suggestion/suggestionsPage.vue'
import Payslip from '@/views/employee/PayslipPage.vue'
import NewEmployeeSuggestion from '@/views/employee/suggestion/createSuggentionPage.vue'
